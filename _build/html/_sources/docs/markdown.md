...
render properly.
For example, if the $this_{is}^{inline}$ references for your book are stored in `references.bib`,
...
````{prf:proof} Orthogonal-Projection-Theorem
:label: my-theorem
